...
const snippetList: { [key: string]: string } = {
  ...
  'right-down':
    `<svg class="arrow right-down" viewBox="-50 -30 100 30" fill="none" xmlns="http://www.w3.org/2000/svg" style="overflow: visible">
      <rect x="-50" y="-30" width="100" height="60" fill="aquamarine"></rect>
  ...
  'down-right':
    `<svg class="arrow down-right" viewBox="-55 -30 110 60" fill="none" xmlns="http://www.w3.org/2000/svg" style="overflow: visible">
      <rect x="-55" y="-30" width="110" height="60" fill="lightblue"></rect>
